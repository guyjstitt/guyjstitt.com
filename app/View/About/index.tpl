<div class="row">
	...
	<div class="scrollimation wid">
		<div class="row fluid">
		  <div class="col-sm-3 col-md-3 scrollimation fadeUp i1">
		    <div class="thumbnail">
		      <img src="sass/assets/responsive.png" alt="picture">
		      <div class="caption">
		  ...
		  <div class="col-sm-3 col-md-3 scrollimation fadeUp i2">
		    <div class="thumbnail">
		      <img src="sass/assets/webapp.png"  alt="picture">
		      <div class="caption">
		  ...
		  <div class="col-sm-3 col-md-3 scrollimation fadeUp i3">
		    <div class="thumbnail">
		      <img src="sass/assets/database.png" alt="picture">
		      <div class="caption">
		  ...
		  <div class="col-sm-3 col-md-3 scrollimation fadeUp i4">
		    <div class="thumbnail">
		      <img src="sass/assets/android-128.png" alt="picture">
		      <div class="caption">
